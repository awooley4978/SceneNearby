...
const londonLocations: FilmingLocation[] = [
  ...
  },
  {
      ...
      const torontoLocations: FilmingLocation[] = [
        ...
        {
          id: 'tor-003', title: 'Elgin Theatre', movieOrShow: 'The Shape of Water', year: 2002,
      ...
      const sydneyLocations: FilmingLocation[] = [
        ...
        {
          id: 'syd-005', title: 'Bare Island Fort', movieOrShow: 'Mission: Impossible 2', year: 2000,
          category: LocationCategory.action, latitude: -33.9930, longitude: 151.2310,
          address: 'Bare Island, La Perouse', city: 'Sydney', country: 'Australia',
          sceneDescription: 'Ethan Hunt infiltrates a fortress-like island for a rendezvous, with the iconic Bare Island fortification providing a dramatic backdrop.',
          funFact: 'Bare Island Fort was built in the 1880s to defend Sydney from naval attack. It was later used as a retirement home for veterans before becoming a film location.',
          quote: 'This is Mission Control, do you copy?',
          quoteAttribution: 'Luther Stickell',
          thenAndNow: 'Bare Island is now a heritage site and popular wedding venue, connected to the mainland by a historic wooden bridge.',
          isMovie: true,
          imageUrl: 'https://pub-d11c6004b03c42edb2633f3ec6a9317b.r2.dev/BareislandFort.jpg',
        },
      ];
